...
INSERT INTO `triggers` VALUES (2,'Line Protocol','.*Line protocol on Interface (\\S+) changed state to (\\S+)','root@localhost','root@localhost','Interface {1}','Link {1} Changed to {2}','Yes');
