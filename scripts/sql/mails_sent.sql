...
--
-- Dumping data for table `mails_sent`
--

LOCK TABLES `mails_sent` WRITE;
/*!40000 ALTER TABLE `mails_sent` DISABLE KEYS */;
/*!40000 ALTER TABLE `mails_sent` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-07-01 14:08:49
