...
CREATE TABLE `ui_layout` (
  ...
  `pagename` enum('Main','Charts','About','Admin','Bugs','Top_Messages','Graph','User','Portlet_Admin','Results') NOT NULL DEFAULT 'Main',
...
) ENGINE=MyISAM AUTO_INCREMENT=1793 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2010-04-23  3:33:26
