...
usage:
    ...
    iopstest [-n|--num_threads threads] [-t|--time time] <device>
...
example:
    ...
    iopstest /dev/sda
    iopstest -n 8 -t 2 /dev/disk0
    iopstest --num_threads 1 --time 2 /dev/md1
    iopstest --num_threads 16 --time 2 /dev/md1
