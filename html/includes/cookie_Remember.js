$(document).ready(function(){
	...
	if(createRememberButton('programs','portlet-header_Programs')){
		handleRememberClickEvent('programs','portlet-content_Programs');
	}	
	setRememberedSelectBoxes('programs','portlet-content_Programs'); 
	...
	if($('#hosts-remember-span').attr('class')=='ui-icon ui-icon-circle-check')
		$('#hosts-remember-span').click();
	if($('#search_Options-remember-span').attr('class')=='ui-icon ui-icon-circle-check')
		$('#search_Options-remember-span').click();
	if($('#fo_checkbox-remember-span').attr('class')=='ui-icon ui-icon-circle-check')
		$('#fo_checkbox-remember-span').click();
	if($('#severities-remember-span').attr('class')=='ui-icon ui-icon-circle-check')
		$('#severities-remember-span').click();
	if($('#facilities-remember-span').attr('class')=='ui-icon ui-icon-circle-check')
		$('#facilities-remember-span').click();
	if($('#programs-remember-span').attr('class')=='ui-icon ui-icon-circle-check')
...
function setRememberedSelectBoxes(portletName,portletDivName){
	var checkedArray=$.cookie('portlet_'+portletName+'_allSelected')==null?null:$.cookie('portlet_'+portletName+'_allSelected');
...
if($.cookie('remember-'+portletName+'-cookie')==null){
	$("#"+portletName+"-remember").detach();
 	$('#'+portletHeaderName).append($('<div class="off" style="float:right" id="'+portletName+'-remember">Remember<span  class="ui-icon ui-icon-circle-close" id="'+portletName+'-remember-span" style="float:right"></span></div>'));
}else{
	$("#"+portletName+"-remember").detach();
 	$('#'+portletHeaderName).append($('<div class="on" style="float:right" id="'+portletName+'-remember">Remember<span id="'+portletName+'-remember-span" class="ui-icon ui-icon-circle-check" style="float:right"></span></div>'));
}
return true;
}
...
function handleRememberClickEventForCheckBox(portletName,portletDivName){
	$("#"+portletName+"-remember").click(function(){
		if($('#'+portletName+'-remember').attr('class')=="off"){
			...
			$('#'+portletName+'-remember').append($('<span id="'+portletName+'-remember-span" class="ui-icon ui-icon-circle-check" style="float:right"></span>'));
...
$.cookie('remember-'+portletName+'-cookie',true, { path: '/', expires: 365 });
			...
			$('#'+portletName+'-remember-span').remove();
			$('#'+portletName+'-remember').append($('<span id="'+portletName+'-remember-span" class="ui-icon ui-icon-circle-close" style="float:right"></span>'));
